...
namespace ginstlog
{
     ...
     */
    [GtkTemplate(ui="/com/github/ehennes775/ginstlog/TripleThermometerWidget.ui.xml")]
    public class TripleThermometerWidget : Gtk.Grid, Gtk.Buildable
    {
        /**
         ...
         */
        private const int READOUT_COUNT = 3;
