...
{
    /**
     * Creates workers for a model 306 thermometer
     */
    public class Model306WorkerFactory : InstrumentWorkerFactory
    {
        /**
         *
         */
        public const string FACTORY_ID = "Model306";


        /**
         * Initialize a new instance
         */
        public Model306WorkerFactory(Xml.Doc* document) throws Error
        {
